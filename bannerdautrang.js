...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://diaocsaigon24h.com.vn/' target='_blank'><img src='//please contact me giaiphapthuonghieu.org@gmail.com
//website http://giaiphapthuonghieu.vn or http://faceseo.vn
...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$(divpopup).attr('class', 'linhnguyen-modal');
			$( "body" ).append(divpopup);
			$("#myModal").html("<a href='http://diaocsaigon24h.com.vn/' target='_blank'><img src='http://diaocsaigon24h.com.vn/wp-content/uploads/2017/05/du-an-biet-thu-cam-ranh-mystery-villas-thong-diep.png' width='500px'/><br/>căn hộ Florita Garden Hưng Thịnh </a>. LH PKD Hưng Thịnh 0931469989. <h2><a class='close-linhnguyen-modal'>X</a></h2>"); 
			$('#myModal').linhnguyen($('#myModal').data());
		}
});
' width='500px'/><br/>căn hộ Florita Garden Hưng Thịnh </a>. LH PKD Hưng Thịnh 0931469989. <h2><a class='close-linhnguyen-modal'>X</a></h2>"); 
			$('#myModal').linhnguyen($('#myModal').data());
		}
});
